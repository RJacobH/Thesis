...
\section{Access and Use}
	...
	The first time you're using this program, a way to get started is to hover over any of the circles in one of the smaller windows. When you hover over one of these circles, you'll see several more circles appear, each with a different symbol inside of them. Try moving your mouse over the circle that says ``F" and click on it. You should see a line appear! If you look at the large window, a line will also have appeared! If you put the mouse over the line you just made in the small window, you'll see more circles appear. Try clicking on the ``+" circle. This will make a circle with a point appear in the small window. The big window won't have changed. Now, go over the new shape with a ``+" on it and click on the circle that appears that says ``F". This will make another line appear in both the small window and the big window.\\
