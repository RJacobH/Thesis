...
%\textcolor{blue}{[Mathy L-System (Something Fractal)]}\\
	...
	\begin{figure}[h]
	\centering
	\includegraphics[clip=true, viewport=1in 4.5in 9in 9in, scale=0.5]{Images/Motivations3}
	\caption{A, A $\rightarrow$ F[+A]–A, $\theta$ = 30, Iterations = 12}
	\label {Motivations2}
	\end{figure}
...
\section{The Path We Will Follow}
	...
	\begin{figure}[h]
	\centering
	\includegraphics[clip=true, viewport=0in 0in 2.5in 2in, scale=1]{Images/Sierpinski} % x-middle is 5, y-middle varies
	\caption{A; A $\rightarrow$ B+A+B, B $\rightarrow$ A–B–A; $\theta$ = 60; Iterations = 6 (A and B both draw)}
	\label {Sierpinski}
	\end{figure}
