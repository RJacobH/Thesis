...
\section{How it works}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[height=3in]{Images/Diagram1}
		%\includegraphics[height = 3in]{Images/HowItWorks5}
	...
	\begin{figure}[h]
	\centering
	\includegraphics[height=3.3in]{Images/Diagram2}
		%\begin{tikzpicture}
	...
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[height = 2in]{Images/HowItWorks7A}
		\caption{Before deletion}
		\label {HowItWorks7A}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[height=2in]{Images/Diagram3}
		\caption{Before deletion (behind the scenes)}
	\end{subfigure}
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[height = 2in]{Images/HowItWorks7C}
		\caption{After deletion}
		\label {HowItWorks7C}
	\end{subfigure}%
	\begin{subfigure}{0.5\textwidth}
		\centering
		\includegraphics[height=2in]{Images/Diagram4}
	...
	\begin{subfigure}{0.33\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Images/Diagram5}
		\caption{F}
	\end{subfigure}%
	\begin{subfigure}{0.33\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Images/Diagram6}
		\caption{F[–}
	\end{subfigure}%
	\begin{subfigure}{0.33\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Images/Diagram7}
		\caption{F[–F}
	\end{subfigure}
	\begin{subfigure}{0.33\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Images/Diagram8}
		\caption{F[–F]+}
	\end{subfigure}
	\begin{subfigure}{0.33\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Images/Diagram9}
		\caption{F[–F]+F}
	\end{subfigure}%
	\begin{subfigure}{0.33\textwidth}
		\centering
		\includegraphics[width=\textwidth]{Images/Diagram10}
		\caption{F[–F]+FA}
	\end{subfigure}
	\caption{The step-by-step creation of a production rule}
	\label{RuleMaking}
	\end{figure}
	...
	\begin{figure}[H]
	\centering
	\includegraphics[height=2in]{Images/Diagram11}
	...
	\begin{figure}[H]
	\centering
	\includegraphics[height=2in]{Images/Diagram12}
...
\subsection{How to Explore}
	...
	\begin{figure}[h]
	\centering
	\includegraphics[height = 1.5in]{Images/HowToExplore3}
...
So far, we've only been looking at L-Systems that fall into a very narrow category. Prusinkiewicz and Lindenmayer go into detail about a number of variations on L-Systems that increase not only their complexity but also their capabilities. I've avoided these extensions for two reasons, one reason being time and the other being a desire to keep the complexity of the L-Systems Explorer low so as to invite in people who might otherwise feel intimidated. I'll focus on three main variations that were discussed in length in \textit{ABOP}, and I invite the reader to explore them if you feel so led.
	...
	\begin{subfigure}{0.44\linewidth}
		...
		\caption{A Snowflake, \cite{myhrvold2021}}
		\label{Snowflake}
	\end{subfigure}%
	\hfill
